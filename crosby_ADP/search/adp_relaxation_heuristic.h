...
class ADPRelaxationHeuristic : public Heuristic {
    ...
    bool vector_has_operator(std::vector<OperatorProxy>, OperatorProxy);
...
protected:
    ...
    std::vector<std::vector<OperatorProxy>> agent_operators_;
    std::vector<OperatorProxy> public_operators_;
    std::vector<OperatorProxy> all_operators;
